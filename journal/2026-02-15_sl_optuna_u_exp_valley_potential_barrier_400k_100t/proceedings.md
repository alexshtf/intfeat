...
setsid -f /bin/bash -lc '
  ...
  EXP_DIR=journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t
  mkdir -p ${EXP_DIR}
  ...
  exec env UV_CACHE_DIR=/tmp/uv_cache PYTHONUNBUFFERED=1 \
    uv run python -m experiments.criteo_fwfm.optuna_sl_u_exp_valley_potential_resumable \
      ...
      --study-name sl_u_exp_valley_potential_barrier_400k \
...
- PID: `journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/pid.txt`
- Log: `journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/run.log`
- Study DB: `journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/study.sqlite3`
- Checkpoint: `journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/checkpoint.json`
- Final summary: `journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/results.json`

## Monitoring

```bash
tail -n 50 journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/run.log
cat journal/2026-02-15_sl_optuna_u_exp_valley_potential_barrier_400k_100t/checkpoint.json
```
...
- Completed: 2026-02-15 (100/100 trials)
  - Best trial: `80` (val logloss `0.4723620800910768`)
  - Final test logloss (best trial retrain): `0.46680955940279606`
